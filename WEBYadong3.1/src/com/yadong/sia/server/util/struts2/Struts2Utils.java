package com.yadong.sia.server.util.struts2;
...
public class Struts2Utils {
	 ...
	 * 直接输出JSON.
	 * 
	 * @param List Java	List,将被转化为json字符串.
	 * @see #render(String, String, String...) 
	 */
	@SuppressWarnings("unchecked")
	public static void renderJson(final List list, final String... headers) {
		...
		sb.append("]");
		render(JSON_TYPE, sb.toString(), headers);
	}
}
