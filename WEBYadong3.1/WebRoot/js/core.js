...
var val=(CURSITE.location=="tag")?((url.indexOf("gid")!=-1)?"/tag/redirect?tagId="+tagId+"&"+url.split("&")[1]:"tag/redirect?tagId="+tagId):url;
}else{
val=url;
}
if(val.indexOf("?")<0){
...
jQuery.ajax({url:""+url+(_669?"/follow":"/unfollow")+(data?"?"+data:""),type:"post",dataType:"json",success:function(r){
if(r.code==0){
if(_66c){
_66c();
}else{
...
var that=this;
jQuery.ajax({url:"zhan/entry/"+id+(_670?"/like":"/unlike")+(data?"?"+data:""),type:"post",dataType:"json",success:function(r){
if(r.code==0){
if(_673){
_673();
}else{
...
var that=this;
jQuery.ajax({url:"tag/"+encodeURIComponent(name)+(_678?"/follow":"/unfollow")+(data?"?"+data:""),type:"post",dataType:"json",success:function(r){
if(r.code==0){
if(_67b){
_67b();
}else{
...
$.ajax({url:"tag/manager/apply/submit",type:"post",data:data,dataType:"json",success:function(r){
if(r.code==0){
...
$.ajax({url:"tag/manager/apply?tagName="+_6ee,type:"get",dataType:"json",success:function(e){
if(e.code==0){
...
jQuery.ajax({url:"zhan/getHotspot",type:"post",data:data,success:function(r){
if(r.code===0){
}
},error:function(){
}});
